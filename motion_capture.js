...
(() => {
  ...
  var __extends2, __awaiter, __generator, __read5, __spreadArray5, __values, TimeoutError;
  ...
  var InstrumentType, NAME_REGEXP;
  ...
  var __read6, HistogramAccumulation, HistogramAggregator;
  ...
  var __read7, __spreadArray6, Buckets, BucketsBacking;
  ...
  var SIGNIFICAND_WIDTH, EXPONENT_MASK, SIGNIFICAND_MASK, EXPONENT_BIAS, MIN_NORMAL_EXPONENT, MAX_NORMAL_EXPONENT, MIN_VALUE;
  ...
  var MIN_SCALE, MAX_SCALE, PREBUILT_MAPPINGS;
  ...
  var __read8, HighLow, MAX_SCALE2, DEFAULT_MAX_SIZE, MIN_MAX_SIZE, ExponentialHistogramAccumulation, ExponentialHistogramAggregator;
  var init_ExponentialHistogram = __esm({
    "node_modules/@opentelemetry/sdk-metrics/build/esm/aggregator/ExponentialHistogram.js"() {
      ...
      MIN_MAX_SIZE = 2;
      ExponentialHistogramAccumulation = /** @class */
      function() {
  ...
  var TMP_PROCESS_RUNTIME_NAME, TMP_TELEMETRY_SDK_NAME, TMP_TELEMETRY_SDK_LANGUAGE, TMP_TELEMETRY_SDK_VERSION, SEMRESATTRS_PROCESS_RUNTIME_NAME, SEMRESATTRS_TELEMETRY_SDK_NAME, SEMRESATTRS_TELEMETRY_SDK_LANGUAGE, SEMRESATTRS_TELEMETRY_SDK_VERSION, TMP_TELEMETRYSDKLANGUAGEVALUES_WEBJS, TELEMETRYSDKLANGUAGEVALUES_WEBJS;
  ...
  var init_sdk_info = __esm({
    "node_modules/@opentelemetry/core/build/esm/platform/browser/sdk-info.js"() {
      init_version2();
      init_esm2();
      SDK_INFO = (_a = {}, _a[SEMRESATTRS_TELEMETRY_SDK_NAME] = "opentelemetry", _a[SEMRESATTRS_PROCESS_RUNTIME_NAME] = "browser", _a[SEMRESATTRS_TELEMETRY_SDK_LANGUAGE] = TELEMETRYSDKLANGUAGEVALUES_WEBJS, _a[SEMRESATTRS_TELEMETRY_SDK_VERSION] = VERSION2, _a);
    }
  });
  ...
  var __read9, LastValueAccumulation, LastValueAggregator;
  ...
  var __read10, SumAccumulation, SumAggregator;
  var init_Sum = __esm({
    "node_modules/@opentelemetry/sdk-metrics/build/esm/aggregator/Sum.js"() {
      init_types2();
      init_MetricData();
  ...
  var __extends4, Aggregation, DropAggregation, SumAggregation, LastValueAggregation, HistogramAggregation, ExplicitBucketHistogramAggregation, ExponentialHistogramAggregation, DefaultAggregation, DROP_AGGREGATION, SUM_AGGREGATION, LAST_VALUE_AGGREGATION, HISTOGRAM_AGGREGATION, EXPONENTIAL_HISTOGRAM_AGGREGATION, DEFAULT_AGGREGATION;
  ...
  var init_AggregationSelector = __esm({
    "node_modules/@opentelemetry/sdk-metrics/build/esm/export/AggregationSelector.js"() {
      ...
      DEFAULT_AGGREGATION_SELECTOR = function(_instrumentType) {
  ...
  var __awaiter2, __generator2, __read11, __spreadArray7, MetricReader;
  ...
  var __extends5, __awaiter3, __generator3, __read12, __spreadArray8, PeriodicExportingMetricReader;
  ...
  var TMP_SERVICE_NAME, TMP_TELEMETRY_SDK_NAME2, TMP_TELEMETRY_SDK_LANGUAGE2, TMP_TELEMETRY_SDK_VERSION2, SEMRESATTRS_SERVICE_NAME, SEMRESATTRS_TELEMETRY_SDK_NAME2, SEMRESATTRS_TELEMETRY_SDK_LANGUAGE2, SEMRESATTRS_TELEMETRY_SDK_VERSION2;
  ...
  var __assign, __awaiter4, __generator4, __read13, Resource;
  var init_Resource = __esm({
    "node_modules/@opentelemetry/resources/build/esm/Resource.js"() {
      init_esm();
      init_esm4();
  ...
  var __extends6, SyncInstrument, UpDownCounterInstrument, CounterInstrument, GaugeInstrument, HistogramInstrument, ObservableInstrument, ObservableCounterInstrument, ObservableGaugeInstrument, ObservableUpDownCounterInstrument;
  var init_Instruments = __esm({
    "node_modules/@opentelemetry/sdk-metrics/build/esm/Instruments.js"() {
      ...
      ObservableCounterInstrument = /** @class */
      function(_super) {
      ...
      ObservableGaugeInstrument = /** @class */
      function(_super) {
      ...
      ObservableUpDownCounterInstrument = /** @class */
      function(_super) {
  ...
  var __extends7, __generator5, HashMap, AttributeHashMap;
  ...
  var __read14, DeltaMetricProcessor;
  ...
  var __values2, __read15, TemporalMetricProcessor;
  ...
  var __extends8, __read16, AsyncMetricStorage;
  ...
  var __awaiter5, __generator6, __read17, __spreadArray9, ObservableRegistry;
  ...
  var __extends9, SyncMetricStorage;
  ...
  var __extends10, AttributesProcessor, NoopAttributesProcessor, FilteringAttributesProcessor, NOOP;
  var init_AttributesProcessor = __esm({
    "node_modules/@opentelemetry/sdk-metrics/build/esm/view/AttributesProcessor.js"() {
      ...
      FilteringAttributesProcessor = /** @class */
      function(_super) {
  ...
  var __awaiter6, __generator7, __read18, MeterSharedState;
  ...
  var __values4, MeterProviderSharedState;
  ...
  var __awaiter7, __generator8, __read19, __spreadArray10, MetricCollector;
  ...
  var __awaiter8, __generator9, __values5, MeterProvider;
  ...
  var __extends11, OTLPExporterError;
  ...
  var __awaiter9, __generator10, BoundedQueueExportPromiseHandler;
  ...
  var __awaiter10, __generator11, OTLPExportDelegate;
  ...
  var __extends12, CumulativeTemporalitySelector, DeltaTemporalitySelector, LowMemoryTemporalitySelector, OTLPMetricExporterBase;
  var init_OTLPMetricExporterBase = __esm({
    "node_modules/@opentelemetry/exporter-metrics-otlp-http/build/esm/OTLPMetricExporterBase.js"() {
      ...
      CumulativeTemporalitySelector = function() {
        return AggregationTemporality.CUMULATIVE;
      };
      DeltaTemporalitySelector = function(instrumentType) {
      ...
      LowMemoryTemporalitySelector = function(instrumentType) {
        switch (instrumentType) {
          case InstrumentType.COUNTER:
          case InstrumentType.HISTOGRAM:
            return AggregationTemporality.DELTA;
  ...
  var __awaiter11, __generator12, MAX_ATTEMPTS, INITIAL_BACKOFF, MAX_BACKOFF, BACKOFF_MULTIPLIER, JITTER, RetryingTransport;
  ...
  var init_send_beacon_transport = __esm({
    "node_modules/@opentelemetry/otlp-exporter-base/build/esm/transport/send-beacon-transport.js"() {
      init_esm();
      SendBeaconTransport = /** @class */
      function() {
  ...
  var init_otlp_browser_http_export_delegate = __esm({
    "node_modules/@opentelemetry/otlp-exporter-base/build/esm/otlp-browser-http-export-delegate.js"() {
      init_retrying_transport();
      init_xhr_transport();
      init_send_beacon_transport();
  ...
  var init_convert_legacy_browser_http_options = __esm({
    "node_modules/@opentelemetry/otlp-exporter-base/build/esm/configuration/convert-legacy-browser-http-options.js"() {
  ...
  var init_create_legacy_browser_delegate = __esm({
    "node_modules/@opentelemetry/otlp-exporter-base/build/esm/configuration/create-legacy-browser-delegate.js"() {
      init_otlp_browser_http_export_delegate();
      init_convert_legacy_browser_http_options();
    }
  });

  // node_modules/@opentelemetry/otlp-exporter-base/build/esm/index-browser-http.js
  var init_index_browser_http = __esm({
    "node_modules/@opentelemetry/otlp-exporter-base/build/esm/index-browser-http.js"() {
      init_create_legacy_browser_delegate();
    }
  });

  // node_modules/@opentelemetry/exporter-metrics-otlp-http/build/esm/platform/browser/OTLPMetricExporter.js
  var __extends13, OTLPMetricExporter;
  var init_OTLPMetricExporter = __esm({
    "node_modules/@opentelemetry/exporter-metrics-otlp-http/build/esm/platform/browser/OTLPMetricExporter.js"() {
      init_OTLPMetricExporterBase();
      init_esm8();
      init_index_browser_http();
  ...
  // node_modules/@opentelemetry/exporter-metrics-otlp-http/build/esm/platform/browser/index.js
  ...
  var require_motion_capture = __commonJS({
    "motion_capture.ts"() {
      ...
      var gpsDisplayInterval = null;
      var inFlightGpsPoll = false;
      var lastGpsFix = null;
      var lastGpsFixAt = 0;
      ...
      function startTracking() {
        ...
        if (navigator.geolocation) {
          ...
          gpsDisplayInterval = window.setInterval(() => {
            ...
            const ageSec = (Date.now() - lastGpsFixAt) / 1e3;
